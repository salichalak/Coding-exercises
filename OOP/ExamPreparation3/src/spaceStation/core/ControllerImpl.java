...
public class ControllerImpl implements Controller {
    ...
    public String report() {
        ...
        sb.append(String.format(ConstantMessages.REPORT_PLANET_EXPLORED, countExploredPlanets))
        ...
        this.astronautRepository.getModels().forEach(a -> {
            ...
            if (a.getBag().getItems().size() == 0) {
                ...
                sb.append(String.format(ConstantMessages.REPORT_ASTRONAUT_BAG_ITEMS, String.join(", ", items)))
                        .append(System.lineSeparator());
            }
        });
